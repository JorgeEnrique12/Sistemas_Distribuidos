...
int main(int argc, char const *argv[])
{
    ...
    char direccion1[INET_ADDRSTRLEN] = "192.168.43.196";
    char direccion2[INET_ADDRSTRLEN] = "192.168.43.96";
    char direccion3[INET_ADDRSTRLEN] = "192.168.43.192";
    char direccion0[INET_ADDRSTRLEN] = "0.0.0.0";
    unsigned int num[3];
    int resto=0;
    num[0] = number;
    num[1] = number - number*.3659;
    num[2] = number - 1;
    resto+=num[1];
    PaqueteDatagrama p1((char *)num,3*sizeof(int),direccion1,7200);
    s1.envia(p1);
    num[0] = number;
    num[1] = number - number*.3361 -  number*.3659;
    num[2] = number - number*.3659 - 1;
    PaqueteDatagrama p2((char *)num,3*sizeof(int),direccion2,7201);
    s1.envia(p2);
    num[0] = number;
    num[1] = 2;
    num[2] = number - number*.3361 -  number*.3659 - 1;
